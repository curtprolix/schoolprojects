...
$yourName = "Curt Schmelzel";

$yourEmail = "curtis.schmelzel@sjsu.edu";

$requiredFields = "join_email, join_username, join_password, join_verify";

$defaultText = "";

$errorText = "Sorry we'll need a user name, email address and password to sign you up";

$successText = "Wow! You've done this before! Bravo";
